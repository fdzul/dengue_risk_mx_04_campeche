...
loc <- rgeomex::extract_locality(cve_edo = "04", 
...
::: {.box .d}
```{r gauge_blocks_campeche,fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .e}
```{r gauge_AGEB_campeche, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_campeche, out.height='100%', out.width = '100%', fig.align = "center"}
...
.wrapper {
    display: grid;
    grid-gap: 2px;
    grid-template-columns: 205px 205px 205px 450px;
...
::: {.box .b}
```{r forest_plot_carmen, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_carmen,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_carmen,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_carmen, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_carmen, out.height='90%', out.width = '90%', fig.align = "center"}
...
::: {.box .b}
```{r forest_plot_escarcega, dpi = 300, fig.height= 5,fig.width = 7,fig.align = "center", out.height='100%', out.width = '100%',fig.show = "hold"}
...
::: {.box .c}
```{r power_law_plot_escarcega,dpi = 300, warning=FALSE, fig.align = "center", out.width = '100%',out.height='100%',fig.show = "hold"}
# Step 7. make the function por calculate the cumulative ####
funcumsum <- function(x){
    x$cumulative_n <- cumsum(x$n_cases)
    x$perc_cumsum_n <- round((cumsum(x$n_cases)/sum(x$n_cases))*100, digits = 1)
...
::: {.box .d}
```{r gauge_blocks_escarcega,fig.align = "center", out.height='100%', out.width = '100%', fig.width= 1.5, fig.height=1}
y_hot <- hotspots |> dplyr::filter(hotspots_gi == 1)
centroid <- rgeomex::blocks_ine20_mx_centroid |>
  sf::st_as_sf(coords = c("x", "y"), crs = 4326)
b_loc <- centroid[hotspots, ]
...
::: {.box .e}
```{r gauge_AGEB_escarcega, fig.align = "center", out.height='100%', out.width = '100%'}
...
::: {.box .f}
```{r gauge_casos_escarcega, out.height='90%', out.width = '90%', fig.align = "center"}
...
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_04_campeche,
                           locality = "San Francisco de Campeche",
                           cve_edo = "04",
...
```{r vector_hotspots_carmen, dpi = 300, warning=FALSE, message=FALSE}
deneggs::map_eggs_hotspots(betas = denmex::eggs_betas_04_campeche,
                           locality = "Ciudad del Carmen",
                           cve_edo = "04",
                           palette = rcartocolor::carto_pal,
...
```{r risk_ageb_campeche}
# Step 1. calculate the risk ####
denhotspots::risk_ageb(betas = denmex::eggs_betas_04_campeche,
                       hotspots = denmex::den_hotspots,
                       intensity_perc = 25,
                       locality = "San Francisco Campeche",
                       cve_edo = "04") |>
